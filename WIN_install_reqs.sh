...
echo ""
echo "In this terminal, start the backend server:"
echo "uvicorn WordNetEndpoint:app --host 0.0.0.0 --port 8001 --reload"
echo ""
echo "_____________________________"
echo "Then open a new Powershell terminal, navigate to the bible-frontend directory and run the commands below:"
echo "npm install react-scripts --save --force"
echo "npm install bootstrap --save --force"
echo ""
