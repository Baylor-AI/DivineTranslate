...
```
cd existing_repo
git remote add origin https://gitlab.com/rivas-bible/rivas-bible.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/rivas-bible/rivas-bible/-/settings/integrations)
